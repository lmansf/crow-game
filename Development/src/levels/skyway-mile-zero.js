...
export default {
  ...
  // mega-map doors on the towpath at both ends, Rookery flyway by the gantry
  entries: {
    west: { x: 150, y: 2370 },
    east: { x: 7830, y: 2370 },
    hub: { x: 330, y: 2370 },
  ...
  exits: [
    ...
    { x: 230, y: 2350, w: 60, h: 150, to: 'the-rookery', entry: 'skyway-mile-zero', label: 'THE ROOKERY', linger: true, vdir: 1 },
  ],
